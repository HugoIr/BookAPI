...
//         * i.e 12 hours then will will return true else false
//         */
//        return extractExpiration(token).before(new Date());
//    }
//
//    /**
//     * this method is for generating token. as argument is username.
//     * so as user first time send request with username and password
//     * so here we will fetch the username,
//     * so based on that username we are going to create one token.
//     */
...
//    // here we are setting the time for 12 hours to expire the token.
